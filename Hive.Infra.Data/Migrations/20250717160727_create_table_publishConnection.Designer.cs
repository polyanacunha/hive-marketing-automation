...
namespace Hive.Infra.Data.Migrations
{
    ...
    [Migration("20250717160727_create_table_publishConnection")]
    partial class create_table_publishConnection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hive.Domain.Entities.MidiaLinks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Hive.Domain.Entities.PublishConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Hive.Infra.Data.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "29891efa-2719-4148-b660-72887d064285",
                            Email = "admin@localhost.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@LOCALHOST.COM",
                            NormalizedUserName = "ADMIN@LOCALHOST.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEL5xBGCdqMDMrC6J6CiWxo5shuHKX1khPA/xvbu7La9LXmABlQJlq6Al3UIFhhioOQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a5688561-427b-4593-99e0-47f39ca21ee7",
            ...
            modelBuilder.Entity("Hive.Domain.Entities.ClientProfile", b =>
                {
                    ...
                    b.Navigation("MidiaLinks");

                    b.Navigation("Midias");

                    b.Navigation("PublishConnections");
                });
