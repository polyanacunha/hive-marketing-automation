...
{
    public class SalesAdSetStrategy : IAdSetConfigStrategy
    {
        public ObjectiveCampaignEnum Objective => ObjectiveCampaignEnum.SALES;
        private readonly IMetaUtilsService _metaUtilsService;

        public SalesAdSetStrategy(IMetaUtilsService metaUtilsService)
        {
        ...
        public async Task<AdSetConfig> BuildAdSetAsync(TargetingStrategy strategy, Campaign campaign, string campaignId, string accessToken)
        {
            ...
            return new AdSetConfig
            {
                ...
                PromotedObject = new()
                {
                    ProductCatalogId = campaign.ProductCatalogId
                }
